    ...
    return (
      <div>
        <div class="bg-purple-200">
          <h1 class="text-center sm:text-left text-3xl sm:text-5xl sm:pl-10">
            Welcome {authContext.authContext.user.name}!
          </h1>
          <div class="flex justify-evenly m-2 gap-2 sm:m-10 text-center text-white">
            <div class="border-0 bg-purple-500 rounded-full shadow-md p-2 sm:p-6 sm:m-4 w-1/3 sm:w-1/4">
